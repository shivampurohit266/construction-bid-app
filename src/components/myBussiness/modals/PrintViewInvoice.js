...
const PrintViewInvoice = ({ businessInfo, userInfo, t }) => {
        ...
        <div className='pdf-section'>
            ...
            <div className='row'>
              ...
              <div className='col-md-4'>
                <div className='float-md-right float-sm-none'>
                  ...
                  <address>
                    {t('proposal_pdf.invoice_no')}
                    {/* {userInfo.invoice_number} */}
                    <br />
                    {t('proposal_pdf.invoice_date')}
                    {/* {userInfo.date} */}
                    <br />
                    {t('proposal_pdf.reference')}
                    {/* {userInfo.reference} */}
                    <br />
                    {t('proposal_pdf.account_number')}
                    {/* {userInfo.acc_no} */}
                    <br />
                    {t('proposal_pdf.payment_duration')}
                    {/* {userInfo.pay_term} */}
                    <br />
                    {t('proposal_pdf.due_date')}
                    {/* {userInfo.due_date} */}
                    <br />
                    {t('proposal_pdf.delay_interests')}
                    {/* {userInfo.interest}% */}
                  </address>
          ...
          <div className='pdf-content'>
            ...
            <div className='row'>
              ...
              <div className='col-md-6'>
                <h4>
                  {t('proposal_pdf._terms')} &amp; {t('proposal_pdf.condition')}{' '}
                </h4>
                {/* <p>{userInfo.terms}</p> */}
                <br />
                <br />
...
export default withTranslation()(PrintViewInvoice);
